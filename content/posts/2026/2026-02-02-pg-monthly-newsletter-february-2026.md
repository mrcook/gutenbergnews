---
title: "Project Gutenberg Newsletter February 2026"
description: "The Project Gutenberg Newsletter for February 2026"
keywords: ["newsletters", "finances", "ark", "tributes"]
date: "2026-02-02T16:19:00"
url: /2026/pg-monthly-newsletter-february-2026/
categories: ["Newsletters"]
tags: ["newsletters", "statistics", "finances"]
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#mourning---celebrating)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#tributes-and-notes-from-our-community)
...
> Presentation title: "Hacker Ethics: How to Teach them, and What they Are". One of the great quotes from the 45 minutes presentation is _Writing code can instrument our ethics._ Watch the full presentation here: [https://youtu.be/sYfYqDPYhWc](https://youtu.be/sYfYqDPYhWc)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#notes-sent-with-donations)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#newsletter-responses)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#from-readers-of-the-globe-and-mail-obituary)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#comments-via-hacker-news)
...
* Greg Newby was also very actively involved in the production of the HOPE Conference. If there's a broadcast tonight, Off The Hook (AKA The Hacker Radio Show) show on WBAI (99.5 FM in NY) and [wbai.org](http://wbai.org) will almost certainly be in his honor. -ethangnawl
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#via-various-social-media-platforms)
...
* My heart bleeds for the loss of Mr. Newby. Sadly, I never got the honor to meet him. He was an inspiration to myself & many others! May he never be forgotten for all the great work he has done on this planet. R.I.P. Greg - digitalwatch\_tower
...
* Greg led the document preparation process for @OpenGridForum for nearly two decades and helped in many ways from small to large in getting the majority of the publications in [https://ogf.org/documents](https://ogf.org/documents) reviewed by the community and published for the betterment of the community. He was a tremendous contributor and friend, and he will be missed. - OpenGridForum
* The entire @[openlibrary.org](http://openlibrary.org) team would like to express our deep sadness at the loss of our friend Greg Newby who, for years, has seeded @[gutenberg.org](http://gutenberg.org) with public good, open access values worth continuing to follow. Thank you for your beautiful contributions. You are missed. -Brewster Kahle
...
* We join others in mourning the loss of Dr. Greg Newby, Project Gutenberg’s leader. We are indebted to @[gutenberg.org](http://gutenberg.org) 's essential and historic role to make published materials available online and to Greg's leadership for helping digital libraries evolve and thrive throughout the decades. -HathiTrust
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#from-eric-pgs-executive-director)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#a-new-feature-ark-linking)
...
In January, Project Gutenberg joined the world of ARKs. This means that if you know Project Gutenberg's number for a book, for example, "Pride and Prejudice" is # 1342, You can use that number from any ARK resolving system. So, for example, while you would normally use the url [https://www.gutenberg.org/ebooks/1342](https://www.gutenberg.org/ebooks/1342) to get the book's landing page, you can also use [https://www.gutenberg.org/ark:/64303/1342](https://www.gutenberg.org/ark:/64303/1342). Now that's not very interesting. But because ARKs can be resolved by any ARK resolver, you can also use [https://n2t.net/ark:/64303/1342](https://n2t.net/ark:/64303/1342) or if you want to use the resolver in France, [https://ark.bnf.fr/ark:/64303/1342](https://ark.bnf.fr/ark:/64303/1342). (64303 is the number that identifies Project Gutenberg)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#new-releases-at-gutenbergorg--january-2026)

In the last month PGLAF added another  [233 new public domain eBooks](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/202601.html) to the PG catalog. Of the new books, 146 were added by PGDP. Thank you to all the volunteers who have helped to make these new titles freely available to the world.
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#links)

* Support Project Gutenberg: [https://www.gutenberg.org/donate/](https://www.gutenberg.org/donate/)
...
[](https://github.com/gutenbergtools/gutenbergsite/blob/dev/site/newsletter/index.md#social-media-feeds)
